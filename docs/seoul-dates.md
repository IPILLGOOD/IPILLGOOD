...
- Periods use an inclusive start and exclusive end. Care Agent retains the previous 14 calendar days, excluding the target date.
- Existing `daysSince` minimum of one day is preserved; prescription dates and recurrence rules are handled separately.
