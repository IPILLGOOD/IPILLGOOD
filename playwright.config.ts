...
export default defineConfig({
  ...
  projects: [
    ...
    { name: "webkit-pill-photo", testMatch: ["**/pill-photo.spec.ts", "**/pwa-shell.spec.ts", "**/google-login-retry.spec.ts"], use: { ...devices["iPhone 13"], browserName: "webkit", serviceWorkers: "block" } },
  ],
