    ...
    <main className="login-page" id="main-content">
      <div className="login-page__brand-column">
        ...
        <div className="login-brand-copy">
          ...
          <p>
            처방 이후의 복약과 몸 상태를 가족이 함께 살피고, 다음 진료에 가져갈
            기록으로 이어가세요.
          </p>
        </div>
        <ul className="login-benefits">
          <li>
            <Check size={16} aria-hidden="true" /> 처방 정보를 쉬운 말로 정리
          </li>
          <li>
            <Check size={16} aria-hidden="true" /> 매일 1분 복약·몸 상태 확인
          </li>
          <li>
            <Check size={16} aria-hidden="true" /> 의료진에게 물어볼 질문 준비
          </li>
        </ul>
      </div>
      ...
      <div className="login-page__panel-column">
        <section className="login-panel" aria-labelledby="login-title">
          <div className="login-panel__heading">
            ...
            <p>
              원하는 방법을 선택하세요. 데모에서는 비식별 샘플만 사용합니다.
            </p>
          </div>
          ...
          <div className="login-access-card">
            ...
            >
              <button
                ...
                className={
                  method === "google"
                    ? "login-method-tab login-method-tab--active"
                    : "login-method-tab"
                }
              ...
              <button
                aria-controls="login-method-panel"
                aria-selected={method === "connection"}
                className={
                  method === "connection"
                    ? "login-method-tab login-method-tab--active"
                    : "login-method-tab"
                }
                onClick={() => setMethod("connection")}
                role="tab"
                type="button"
              >
              ...
              {method === "google" ? (
                <>
                  <div className="login-method-copy">
                    ...
                    <span>
                      ...
                      <small>
                        돌봄 기록을 만들고 함께 사용할 사람을 초대할 수 있어요.
                      </small>
                    </span>
                  </div>
                  <GoogleSignInButton />
                ...
                <>
                  <div className="login-method-copy">
                    ...
                    <span>
                      <strong>초대받은 돌봄 화면 연결하기</strong>
                      <small>
                        전달받은 8자리 코드만 입력하면 같은 화면을 바로 볼 수
                        있어요.
                      </small>
                    </span>
                  </div>
                  <form
                    className="connection-login-form"
                    action="/api/auth/connection/redeem"
                    method="post"
                  >
                    <label id="connection-code-label" htmlFor="connection-code">
                      연결 코드
                    </label>
                    <div className="connection-login-form__row">
                      <ConnectionCodeInput />
                      <button className="login-demo-button" type="submit">
                        연결하기 <ArrowRight size={17} aria-hidden="true" />
                      </button>
                    </div>
                  </form>
                </>
