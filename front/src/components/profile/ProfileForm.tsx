...
import { ConfirmedConditionsEditor } from "./ConfirmedConditionsEditor";
  ...
  return (
    <form action={action}>
      ...
      <div className="form-grid">
        ...
        <div className="field form-grid__wide"><ConfirmedConditionsEditor conditions={recipient.confirmedConditions ?? []} /></div>
