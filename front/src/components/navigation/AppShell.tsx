...
export function AppShell({
  ...
  const pathname = usePathname();
  const isPublicPage = pathname === "/" || pathname === "/login" || pathname === "/account/recovery" || pathname === "/404" || pathname === "/preview-device" || pathname === "/preview-v2" || pathname === "/preview" || pathname.startsWith("/preview/");
