...
test("Firestore emulator는 demo 프로젝트와 loopback 조합만 허용한다", () => {
  ...
  assert.doesNotThrow(() => assertSafeFirestoreEmulator("care-atlas-seoul-2026-v2", undefined));
  assert.throws(() => assertSafeFirestoreEmulator("care-atlas-seoul-2026-v2", "127.0.0.1:8181"));
